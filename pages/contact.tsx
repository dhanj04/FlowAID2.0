...
export default function Contact() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen font-['Product_Sans', 'sans-serif']">
      <Head>
        <title>Contact Us - flowAID</title>
        <meta name="description" content="Get in touch with the flowAID team" />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden">
              <div className="md:flex">
                ...
                <div className="bg-blue-600 text-white p-8 md:w-1/3">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-blue-100">123 Healthcare Avenue<br />Medical District<br />New Delhi, 110001</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-blue-100">+91 123 456 7890</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-blue-100">contact@flowaid.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-blue-100">Monday - Friday: 9AM - 5PM<br />Saturday: 9AM - 1PM<br />Sunday: Closed</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-12">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="bg-blue-500 hover:bg-blue-400 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300">
                ...
                {/* Contact Form */}
                <div className="p-8 md:w-2/3 dark:bg-gray-800">
            ...
            <div className="mt-16">
              ...
              <div className="bg-gray-200 dark:bg-gray-700 h-96 rounded-xl overflow-hidden">
