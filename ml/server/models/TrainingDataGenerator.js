...
class TrainingDataGenerator {
   ...
   */
  calculateRealisticWaitTime(patient, facility) {
   ...
   */
  generateTrainingData(count = 1000) {
    const trainingData = [];
   ...
   */
  generatePatientDataset(count = 50) {
    const patients = [];
